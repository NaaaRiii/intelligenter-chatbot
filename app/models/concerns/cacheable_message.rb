...
module CacheableMessage
  ...
  class_methods do # rubocop:disable Metrics/BlockLength
    ...
    def expire_conversation_cache(conversation_id)
      Rails.cache.delete_matched(%r{\A#{CACHE_KEY_PREFIX}/conversation/#{conversation_id}/})
      Rails.cache.delete_matched(%r{\A#{CACHE_KEY_PREFIX}/recent/})
    end
  end
  ...
  def expire_redis_caches
    ...
    pattern = "#{CacheableMessage::CACHE_KEY_PREFIX}/conversation/#{conversation_id}/*"
